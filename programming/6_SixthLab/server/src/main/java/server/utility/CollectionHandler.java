 ...
 * @author AstroSoup
 */
public class CollectionHandler implements shared.CollectionHandler {
    ...
    public static CollectionHandler getHandler() {
        if (INSTANCE == null) {
            ...
            COLLECTIONLOGGER.setUseParentHandlers(true);
        }
        return INSTANCE;
    }
    ...
    public void add(Ticket ticket) throws InvalidObjectException {
        ...
        COLLECTIONLOGGER.fine("В коллекцию добавлен билет № " + ticket.getId());
    }
    ...
    public void clear() {
        collection.clear();
        COLLECTIONLOGGER.fine("Коллекция очищена.");
    }
    ...
    public void remove(Ticket ticket) {
        ...
        COLLECTIONLOGGER.fine("Из коллекции удален билет № " + ticket.getId());
    }
    ...
    public void save() throws NotEnoughRightsToWriteException, IOException {
        ...
        COLLECTIONLOGGER.fine("Коллекция сохранена в файл " + path);
    }
}
