...
public class ConsoleParser extends Parser {
     ...
     */
    public ConsoleParser(TextUI textUI, ClientCommandHandler invoker) {
    ...
    public String parseName() {
        try {
            ...
            textUI.outputLn("Неверный аргумент. Поле не может быть пустым. Длина имени не может превышать 1000 символов.");
            return parseName();
        }
    }
